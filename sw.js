...
if(Array.isArray(ASSETS)){
  [
    ...
    './r145-history-buttons-live.js?v=R145-history-buttons-live-0945',
...
/* R145 — wyłącznie aktywacja funkcji istniejących przycisków karty HISTORIA. Zero zmian stałej grafiki MASTER. */
importScripts('./r145-history-buttons-live.js?v=R145-history-buttons-live-0945');
