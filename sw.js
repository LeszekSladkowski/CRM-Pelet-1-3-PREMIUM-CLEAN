/* R128 v4.6E — FAKTY DO ROZMOWY: TRUE 1 ENTER WHITE TEXT START
   Baza: R128 v4.5I — główna karta NOTATKI O FIRMIE FINAL MASTER.
   Zakres v4.6E: wyłącznie karta szczegółowa FAKTY DO ROZMOWY i biały tekst w czerwonym polu NAJWAŻNIEJSZY WNIOSEK HANDLOWY.
   Pozostałe karty, ANPOL, linia POLSKA/DOSTAWCA/PRIORYTET B, PNG, ikony, routing i karta końcowa bez zmian.
*/
importScripts('./sw-r127-language-base.js?v=R128-v4-6e-talk-detail-true-one-enter-fix');
...
const r128v46eBasePatch=r48PatchIndexHtml;
r48PatchIndexHtml=function(text){
  let out=r128v46eBasePatch(text);
  ...
  out=out.replace(/const BUILD_TIME = '[^']*';/,"const BUILD_TIME = '13:56';");
  out=out.replace(/sw\.js\?v=R128v4-[0-9a-z-]*/g,'sw.js?v=R128v4-6e-talk-detail-true-one-enter-fix-1356');
  out=out.replace(/r84-backup-prune\.js\?v=R128v4-[0-9a-z-]*/g,'r84-backup-prune.js?v=R128v4-6e-1356');
  ...
  /* v4.6E — osobny chirurgiczny patch tylko dla FAKTY DO ROZMOWY. */
